    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-red-500/30 font-sans pb-0 overflow-x-hidden w-full max-w-[100vw]">
      ...
      <section className="relative min-h-[100dvh] h-auto pt-24 pb-16 sm:pt-28 sm:pb-20 md:pt-36 md:pb-24 flex flex-col items-center justify-start md:justify-center px-4 sm:px-6 md:px-12 lg:px-24 w-full overflow-hidden">
        ...
        <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="relative z-10 w-full max-w-6xl mx-auto text-center mt-6 sm:mt-10 md:mt-14">
          <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-3.5 py-1.5 sm:px-4 sm:py-2 rounded-full bg-red-500/10 border border-red-500/20 mb-4 sm:mb-6">
            <span className="w-2 h-2 rounded-full bg-red-500 animate-pulse"></span>
            <span className="text-xs sm:text-sm font-semibold tracking-wider text-red-500 uppercase">UX/UI Concept</span>
          </motion.div>
          <motion.h1 variants={fadeInUp} className="text-3xl sm:text-5xl md:text-7xl font-bold tracking-tight mb-4 sm:mb-6 text-white drop-shadow-2xl leading-[1.1] max-w-5xl mx-auto">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeInUp} className="bg-zinc-900 border border-zinc-800 rounded-[2rem] md:rounded-[3rem] p-8 md:p-12 lg:p-16 flex flex-col md:flex-row items-center relative overflow-hidden shadow-2xl group">
          ...
          <div className="flex-1 w-full mt-12 md:mt-0 relative z-10 flex justify-center md:justify-end">
              ...
              <div className="w-full max-w-[250px] h-[250px] md:max-w-[300px] md:h-[300px] relative flex items-center justify-center">
                <div className="absolute inset-0 bg-gradient-to-br from-red-500/10 to-orange-500/10 rounded-full blur-[50px] group-hover:blur-[70px] transition-all duration-700"></div>
                ...
                <div className="absolute z-30 w-36 bg-zinc-900/90 backdrop-blur-md border border-zinc-800 rounded-3xl p-4 shadow-[0_0_30px_rgba(239,68,68,0.2)] flex flex-col transition-transform duration-700 group-hover:scale-110 translate-x-0">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex justify-between items-center">
                      <div className="h-1.5 bg-zinc-700 rounded w-12"></div>
                      <div className="h-1.5 bg-zinc-600 rounded w-8"></div>
                    </div>
                    <div className="flex justify-between items-center">
                      <div className="h-1.5 bg-zinc-700 rounded w-16"></div>
                      <div className="h-1.5 bg-zinc-600 rounded w-10"></div>
                    </div>
                  </div>
                  <div className="w-full h-8 bg-gradient-to-r from-red-500 to-orange-500 rounded-xl flex items-center justify-center shadow-inner">
                ...
                <div className="absolute z-20 w-32 bg-zinc-800/90 backdrop-blur-sm border border-zinc-700/50 rounded-2xl p-3 shadow-xl transition-all duration-700 -translate-x-16 translate-y-16 md:-translate-x-20 md:translate-y-20 group-hover:-translate-x-28 group-hover:translate-y-24 group-hover:rotate-3 animate-pulse" style={{ animationDuration: '4s' }}>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <div className="flex-1">
                      <div className="h-2 bg-zinc-600 rounded w-full mb-1.5"></div>

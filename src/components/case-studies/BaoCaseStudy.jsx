    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-orange-500/30 font-sans pb-0 overflow-x-hidden w-full max-w-[100vw]">
      ...
      <section className="relative min-h-[100dvh] h-auto pt-24 pb-16 sm:pt-28 sm:pb-20 md:pt-36 md:pb-24 flex flex-col items-center justify-start md:justify-center px-4 sm:px-6 md:px-12 lg:px-24 w-full overflow-hidden">
        <div className="absolute inset-0 w-full h-full z-0">
           <ZoomableImage src="/uploads/bao/cover-main.jpg" alt="BAO Hero" className="w-full h-full object-cover object-[center_top] md:object-center" />
        ...
        <motion.div initial="hidden" animate="visible" variants={staggerContainer} className="relative z-10 w-full max-w-6xl mx-auto text-center mt-6 sm:mt-10 md:mt-14">
          <motion.div variants={fadeInUp} className="inline-flex items-center gap-2 px-3.5 py-1.5 sm:px-4 sm:py-2 bg-orange-500/10 border border-orange-500/20 rounded-full mb-4 sm:mb-6">
            <span className="w-2 h-2 rounded-full bg-orange-500 animate-pulse"></span>
            <span className="text-orange-400 text-xs sm:text-sm font-medium">B2C Service</span>
          </motion.div>

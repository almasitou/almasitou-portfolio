    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-blue-500/30 font-sans pb-0 overflow-x-hidden w-full max-w-[100vw]">
      ...
      <section className="px-6 md:px-12 lg:px-24 max-w-7xl mx-auto mb-20 md:mb-32">
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={staggerContainer} className="text-left">
          ...
          <div className="flex flex-row flex-wrap justify-center md:justify-start items-center gap-y-3 md:gap-y-4 gap-x-2 md:gap-x-3 relative z-10 w-full">
            {['Идея', 'Создание контента', 'Планирование публикаций', 'Публикация во всех соцсетях', 'Аналитика', 'Рекомендации AI-ассистента'].map((step, idx, arr) => (
              <React.Fragment key={idx}>
                ...
                {idx < arr.length - 1 && (
                  <motion.div variants={fadeInUp} className="flex text-zinc-600 shrink-0">
